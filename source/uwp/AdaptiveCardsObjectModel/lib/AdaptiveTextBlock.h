...
namespace AdaptiveCards::ObjectModel::Uwp
{
    ...
    public:
        ...
        IFACEMETHODIMP get_Style(_Out_ ABI::AdaptiveCards::ObjectModel::Uwp::TextStyle* style) override;
        IFACEMETHODIMP put_Style(ABI::AdaptiveCards::ObjectModel::Uwp::TextStyle style) override;
        ...
        IFACEMETHODIMP put_IsSubtle(boolean isSubtle) override { return AdaptiveTextElement::put_IsSubtle(isSubtle); }
        ...
        IFACEMETHODIMP get_FontType(_Out_ ABI::AdaptiveCards::ObjectModel::Uwp::FontType* type) override
        {
            return AdaptiveTextElement::get_FontType(type);
        }
        IFACEMETHODIMP put_FontType(ABI::AdaptiveCards::ObjectModel::Uwp::FontType type) override
        {
    ...
    private:
        ...
        ABI::AdaptiveCards::ObjectModel::Uwp::TextStyle m_style;
    };
