...
namespace AdaptiveCards::ObjectModel::Uwp
{
    ...
    public:
        ...
        IFACEMETHODIMP put_Title(_In_ HSTRING title) override;
        ...
        IFACEMETHODIMP get_ValueOff(_Outptr_ HSTRING* value) override;
        IFACEMETHODIMP put_ValueOff(_In_ HSTRING value) override;

        IFACEMETHODIMP get_ValueOn(_Outptr_ HSTRING* value) override;
        IFACEMETHODIMP put_ValueOn(_In_ HSTRING value) override;
